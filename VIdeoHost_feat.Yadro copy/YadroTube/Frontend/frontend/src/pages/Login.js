...
      await axios.post('http://212.164.112.171:8000/api/register/', {
        username,
        email,
        password,
...
      const res = await axios.post('http://212.164.112.171:8000/api/token/', { username, password }); // Обычно для токена используется username
